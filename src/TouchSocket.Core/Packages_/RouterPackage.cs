...
#endif
    {
        writer.WriteString(this.SourceId, FixedHeaderType.Byte);
        writer.WriteString(this.TargetId, FixedHeaderType.Byte);
    }
...
#endif
    {
        this.SourceId = reader.ReadString(FixedHeaderType.Byte);
        this.TargetId = reader.ReadString(FixedHeaderType.Byte);
    }
}