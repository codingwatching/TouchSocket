...
public interface ISerializationSelector
{
    ...
    object DeserializeParameter<TReader>(ref TReader reader, SerializationType serializationType, Type parameterType) where TReader : IByteBlockReader
#if AllowsRefStruct
,allows ref struct
#endif
        ;
    ...
    void SerializeParameter<TWriter>(ref TWriter wirter, SerializationType serializationType, in object parameter) where TWriter : IByteBlockWriter
#if AllowsRefStruct
,allows ref struct
#endif
        ;
