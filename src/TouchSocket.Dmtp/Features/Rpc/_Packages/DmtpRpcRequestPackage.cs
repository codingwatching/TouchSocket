...
internal class DmtpRpcRequestPackage : WaitRouterPackage, IDmtpRpcRequestPackage
{
    ...
    public override void PackageBody<TWriter>(ref TWriter writer)
    {
        ...
        {
            writer.WriteByte((byte)this.m_parameters.Length);
    ...
    public override void PackageRouter<TWriter>(ref TWriter writer)
    {
        ...
        writer.WriteByte((byte)this.m_serializationType);
        writer.WriteString(this.InvokeKey, FixedHeaderType.Byte);
        writer.WriteByte((byte)this.m_feedback);
    ...
    public override void UnpackageRouter<TReader>(ref TReader reader)
    {
        ...
        this.m_serializationType = (SerializationType)reader.ReadByte();
        this.m_invokeKey = reader.ReadString(FixedHeaderType.Byte);
        this.m_feedback = (FeedbackType)reader.ReadByte();
